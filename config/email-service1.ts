...
export default async function sendEmailByBrevo(to: string, url: string) {
    ...
    const mailOptions = {
        from: "IIC - ISLEC <noreply@ticket.iic.islec.edu.in>",
        to: to,
...
const email = await sendEmailByBrevo("syedaliquadri100@gmail.com", "https://google.com");
console.log(email);
